  ...
  return (
    <div>
      <main className="pricing_page ">
        <section className="pricing_top negativeZIndex">
                ...
                <div className="tab tab-active" data-id="tabOne">
                  <div className="tab-content">
                    <div className="switch-container">
                      ...
                      {/* <div className="switcher-box">
                                        <div className="content">
                                            <label className="toggler toggler--is-active" id="do-premium">Premium</label>
                                            <div className="toggle">
                                                <input type="checkbox" id="switcher" className="check"/>
                                                <b className="b switch"></b>
                                            </div>
                                            <label className="toggler" id="do-standard">Standard</label>
                                        </div>
                                    </div> */}
