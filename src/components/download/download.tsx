...
export default function DownloadBanner() {
  const [activeLink, setActiveLink] = React.useState('chrome');
          ...
          <div className="hero_container ">
            <div className="hero_content">
              ...
              <div className="content">
                ...
                <p>
                  Navigating Visa Complexities for a seamless journey abroad.
                  Visa consulting website is crucial to engage and convey the
                  value your services offer
                </p>
            ...
            <div className="hero_clipart ">
              <img src="/downloads/hero-clipart.png" alt="hero-clipart" />
            </div>
          </div>
        </section>
          ...
          <div className="container">
            <ul className="extension_listing">
              <li>
                <a
                  href="#"
                  className={activeLink === 'mac' ? 'active' : ''}
                  onClick={() => handleActiveLink('mac')}
                >
                  <span className="icon">
                    <StaticImage
              ...
              <li>
                <a
                  href="#"
                  className={activeLink === 'firefox' ? 'active' : ''}
                  onClick={() => handleActiveLink('firefox')}
                >
                  <span className="icon">
                    <StaticImage
              ...
              <li>
                <a
                  href="#"
                  className={activeLink === 'chrome' ? 'active' : ''}
                  onClick={() => handleActiveLink('chrome')}
                >
                  <span className="icon">
                    <StaticImage
              ...
              <li>
                <a
                  href="#"
                  className={activeLink === 'edge' ? 'active' : ''}
                  onClick={() => handleActiveLink('edge')}
                >
                  <span className="icon">
                    <StaticImage
              ...
              <li>
                <a
                  href="#"
                  className={activeLink === 'android' ? 'active' : ''}
                  onClick={() => handleActiveLink('android')}
                >
                  <span className="icon">
                    <StaticImage
          ...
          <div className="container">
            <div className="why_esb_content">
              ...
              <div className="content_row">
                ...
                <div className="left_clipart">
                  <StaticImage
                    src="../../images/download/why-esb-shape2.png"
                    alt="tick-icon"
                    title="tick-icon"
                    className="d-inline-block align-text-top img-fluid"
                    layout="fixed"
              ...
              <div className="content_row">
                <div className="left_clipart">
                  <StaticImage
                    src="../../images/download/why-esb-shape3.png"
                    alt="tick-icon"
                    title="tick-icon"
                    className="d-inline-block align-text-top img-fluid"
                    layout="fixed"
