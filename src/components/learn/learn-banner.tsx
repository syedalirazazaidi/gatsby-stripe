...
export default function LearnBanner() {
  ...
  return (
    <main className="learn_page" onMouseOver={closeSubmenu}>
          ...
          <div className="row no-margin learn_hero_container">
            <div className="col-xxl-3 col-md-6 col-sm-12">
              ...
              <div className="color_box pink">
                <span className="icon_container">
                  <StaticImage
                    src="../../images/icons/learn-icn-1.svg"
                    alt=""
                    title=""
                  />
                </span>
            ...
            <div className="col-xxl-3 col-md-6 col-sm-12">
              ...
              <div className="color_box green">
                <span className="icon_container">
                  <StaticImage
                    src="../../images/icons/learn-icn-2.svg"
                    alt=""
                    title=""
                  />
                </span>
            ...
            <div className="col-xxl-3 col-md-6 col-sm-12">
              ...
              <div className="color_box sky">
                <span className="icon_container">
                  <StaticImage
                    src="../../images/icons/learn-icn-3.svg"
                    alt=""
                    title=""
                  />
                </span>
            ...
            <div className="col-xxl-3 col-md-6 col-sm-12">
              ...
              <div className="color_box yellow">
                <span className="icon_container">
                  <StaticImage
                    src="../../images/icons/learn-icn-4.svg"
                    alt=""
                    title=""
                  />
                </span>
            ...
            <div className="col-xxl-9 col-md-12 col-sm-12">
              ...
              >
                ...
                <a href="#" className="arrow-right">
                  <StaticImage
                    src="../../images/learn/carousal-arrow.svg"
                    alt=""
                    title=""
                  />
                </a>
